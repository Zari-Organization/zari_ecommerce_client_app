...
import 'package:zariecommerce/data/model/body/review_body.dart';
...
class ProductDetailsProvider extends ChangeNotifier {
  ...
  void initProduct(Product product, BuildContext context) async {
    ...
    if (reviewResponse.response != null && reviewResponse.response.statusCode == 200) {
        Provider.of<BannerProvider>(context,listen: false).getProductDetails(context, product.id.toString());
      _reviewList = [];
