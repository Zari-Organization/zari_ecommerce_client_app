...
import 'package:zariecommerce/view/basewidget/not_loggedin_widget.dart';
import 'package:zariecommerce/view/basewidget/search_widget.dart';
import 'package:zariecommerce/view/screen/wishlist/widget/wishlist_widget.dart';
          ...
          Expanded(
            child: isGuestMode ? NotLoggedInWidget() :  Consumer<WishListProvider>(
              builder: (context, wishListProvider, child) {
                ...
                ) : WishListShimmer(): NoInternetOrDataScreen(isNoInternet: false);
              },
            ),
          ),
        ],
