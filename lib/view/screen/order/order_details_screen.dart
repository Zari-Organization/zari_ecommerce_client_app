...
import 'package:zariecommerce/view/basewidget/shimmer_loading.dart';
import 'package:zariecommerce/view/screen/seller/seller_screen.dart';
import 'package:zariecommerce/data/model/response/order_details.dart';
...
import 'package:zariecommerce/view/basewidget/amount_widget.dart';
import 'package:zariecommerce/view/basewidget/button/custom_button.dart';
import 'package:zariecommerce/view/basewidget/custom_app_bar.dart';
import 'package:zariecommerce/view/basewidget/show_custom_snakbar.dart';
import 'package:zariecommerce/view/basewidget/title_row.dart';
import 'package:zariecommerce/view/screen/order/widget/order_details_widget.dart';
import 'package:zariecommerce/view/screen/payment/payment_screen.dart';
import 'package:zariecommerce/view/screen/support/support_ticket_screen.dart';
import 'package:zariecommerce/view/screen/tracking/tracking_screen.dart';
                    ...
                    ? ListView(
                        ...
                        children: [
                            ...
                            child: Row(
                              children: [
                                  ...
                                  text: TextSpan(
                                    children: <TextSpan>[
                                      TextSpan(
                                          ...
                                          style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).textTheme.bodyText1.color,
                                          )),
                                      TextSpan(
                                ...
                                Text(DateConverter.localDateToIsoStringAMPM(DateTime.parse(order.trackingModel.createdAt)),
                                    style: titilliumRegular.copyWith(color: ColorResources.getTextTitle(context),fontSize: Dimensions.FONT_SIZE_SMALL)),
                              ],
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start,
                                  ...
                                  Consumer<ProfileProvider>(
                                    builder: (context, profile, child) {
                                      print('=====Addreesss====>$shippingAddress');

                                        if (profile.addressList != null) {
                                        profile.addressList.forEach((address) {

                                          if (address.id == order.trackingModel.shippingAddress) {shippingAddress = address.address;}});
                                      }
                                      return Expanded(child: Text(shippingAddress, maxLines: 3 ,style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL)));
                                    },
                                  ),
                                ]),
                                Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start,
                                  children: [
                                    Text('${getTranslated('billing_address', context)} :',  style: titilliumRegular),
                                    Expanded(child: Text(' ${orderModel.billingAddressData != null ? orderModel.billingAddressData.address : orderModel.billingAddress ?? ''}', maxLines: 3, overflow: TextOverflow.ellipsis, style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL))),
                                  ],
                                ),
                                ...
                                Row(children: [
                                  Expanded(
                                      child: Text(getTranslated('SHIPPING_PARTNER', context), style: titilliumRegular)),
                          ...
                          Padding(
                            ...
                            child: Text('${getTranslated('order_note', context)} : ${orderModel.orderNote != null?orderModel.orderNote ?? '': ""}', style: titilliumRegular),
                          ),
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      ListView.builder(
                                        ...
                                        physics: NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, i) => OrderDetailsWidget(orderDetailsModel: sellerProductList[index][i], callback: () {showCustomSnackBar('Review submitted successfully', context, isError: false);}),
                                      ),
                                    ]),
                              );
                            },
