...
import 'package:zariecommerce/view/screen/auth/widget/sign_in_widget.dart';
import 'package:zariecommerce/view/screen/auth/widget/sign_up_widget.dart';
            ...
            builder: (context, auth, child) => SafeArea(
              child: Column(
                ...
                children: [
                  ...
                  // for logo with text
                  Image.asset(Images.black_logo, height: 150, width: 200),
