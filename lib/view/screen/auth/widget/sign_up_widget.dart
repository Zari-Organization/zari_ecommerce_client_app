...
import 'package:zariecommerce/data/model/body/register_model.dart';
import 'package:zariecommerce/helper/email_checker.dart';
...
class _SignUpWidgetState extends State<SignUpWidget> {
  ...
  void initState() {
    ...
    // _countryDialCode = CountryCode.fromCode(Provider.of<SplashProvider>(context, listen: false).configModel.countryCode).dialCode;
