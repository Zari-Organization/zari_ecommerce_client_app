...
import 'package:zariecommerce/view/screen/auth/auth_screen.dart';
import 'package:zariecommerce/view/screen/dashboard/dashboard_screen.dart';
import 'package:zariecommerce/view/screen/maintenance/maintenance_screen.dart';
import 'package:zariecommerce/view/screen/onboarding/onboarding_screen.dart';
import 'package:zariecommerce/view/screen/splash/widget/splash_painter.dart';
        ...
        clipBehavior: Clip.none, children: [
          ...
          Center(
            child: Column(
              ...
              children: [
                Image.asset(Images.white_logo, height: 250.0, fit: BoxFit.scaleDown, width: 250.0),
              ],
            ),
          ),
        ],
